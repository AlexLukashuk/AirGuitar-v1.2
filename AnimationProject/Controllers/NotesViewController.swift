...
class NotesViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        menuBarButtonItem = UIBarButtonItem(image: #imageLiteral(resourceName: "ic_menu_white_3x").withRenderingMode(.alwaysTemplate).withTintColor(Config.shared.myTintColor!), style: .plain, target: self, action: #selector(menuBarButtonTouched))
